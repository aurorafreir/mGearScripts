...
# guide info
AUTHOR = "Aurora Freir"
URL = "www.linkedin.com/in/aurora-freir/"
EMAIL = ""
VERSION = [0, 0, 1]
TYPE = "eye_rig_01"
NAME = "eye"
DESCRIPTION = "Single Eye Rig component :)."
...
class Guide(guide.ComponentGuide):
    ...
    # @param self
    def postInit(self):
        self.save_transform = ["root", "aim", "lower_full", "upper_full"]
    ...
    def addObjects(self):
        ...
        self.aim = self.addLoc("aim", self.root, [0, 0, 10])

        self.lower_full = self.addLoc("lower_full", self.root, [0,-1,0])
        self.upper_full = self.addLoc("upper_full", self.root, [0, 1,0])

        self.dispcrv = self.addDispCurve("crv", [self.root, self.aim])
